...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            ENR = tk.Label(MFW, text="Enter ID Number", width=15, height=2, fg="black", bg="grey",
                           font=('times', 15))
            ...
            def create_csv():
                ...
                csv_name = 'C:/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')

            attf = tk.Button(MFW,  text="Check Sheets", command=attf, fg="black", bg="dark gray",
...
def subjectchoose():
    ...
    attf = tk.Button(windo,  text="Check Sheets", command=Attf, fg="black", bg="dark gray",
                     width=12, height=1, activebackground="white", font=('times', 14, ' bold '))
    ...
    fill_a = tk.Button(windo, text="Fill Attendance", fg="white", command=Fillattendances, bg="cornsilk4", width=20, height=2,
...
def admin_panel():
    ...
    c0 = tk.Button(win, text="Clear", command=c00, fg="white", bg="bisque2", width=10, height=1,
                   activebackground="white", font=('times', 15, ' bold '))
    c0.place(x=690, y=55)

    c1 = tk.Button(win, text="Clear", command=c11, fg="white", bg="bisque2", width=10, height=1,
                   activebackground="white", font=('times', 15, ' bold '))
...
def trainimg():
    ...
    res = "CHECK COMPLETED CONTINUE...."  # +",".join(str(f) for f in Id)
...
def on_closing():
    ...
    if messagebox.askokcancel("DONE", "HAVE YOU DONE"):
        window.destroy()


window.protocol("WM_DELETE_WINDOW", on_closing)

message = tk.Label(window, text="TAKE ATTENDACE", bg="dark goldenrod", fg="black", width=45,
                   height=2, font=('times', 30, ' underline '))
...
lbl = tk.Label(window, text="Enter ID Number : ", width=20, height=2,
               fg="snow", bg="black", font=('times', 15, 'bold'))
...
lbl2 = tk.Label(window, text="Enter Name : ", width=20, fg="snow",
...
clearButton = tk.Button(window, text="Clear", command=clear, fg="black", bg="bisque2",
                        width=10, height=1, activebackground="white", font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear", command=clear1, fg="black", bg="bisque2",
                         width=10, height=1, activebackground="white", font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Registered students", command=admin_panel, fg="black",
               bg="DarkSalmon", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="TAKE IMAGES", command=take_img, fg="white", bg="DarkSlateGrey",
                    width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="CHECK IMAGE", fg="white", command=trainimg, bg="DarkSlateGrey",
                     width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="FILL ATTENDANCE", fg="white", command=subjectchoose,
               bg="DarkSlateGrey", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
